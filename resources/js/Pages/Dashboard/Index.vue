...
if (props.user.role_id==1) {
    cards.value = [
        { name: 'Semua Kelas', href: 'course.index', icon: 'fa-book', amount: props.course.length },
        { name: 'Semua Proyek', href: 'project.index', icon: 'fa-browser', amount: props.project.length },
    ]
