...
<template>
    <AppLayout title="Galeri"
        ...
        <div class="flex justify-between gap-3">
            ...
            <div class="">
<!--                <PrimaryButton as="a" :href="route('gallery.create')" >Tambah</PrimaryButton>-->
            </div>
        </div>
...
<!--&lt;!&ndash;                  class="mt-2 mr-2"&ndash;&gt;-->
<!--&lt;!&ndash;                  type="button"&ndash;&gt;-->
<!--&lt;!&ndash;                  :class="{ 'opacity-25': form.processing }"&ndash;&gt;-->
<!--&lt;!&ndash;                  :disabled="form.processing"&ndash;&gt;-->
<!--&lt;!&ndash;                  @click="storePhoto"&ndash;&gt;-->
<!--&lt;!&ndash;              >&ndash;&gt;-->
<!--&lt;!&ndash;                  Simpan Foto&ndash;&gt;-->
<!--&lt;!&ndash;              </PrimaryButton>&ndash;&gt;-->
