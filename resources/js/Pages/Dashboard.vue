...
<!--                    />-->
                ...
                <div class="grow">
                    ...
                    <Link href="" class="text-sm text-primary-600 font-medium">Link <i class="fa-regular fa-arrow-right" /></Link>
                </div>
            </div>
        </div>
...
<!--                    <Link :href="route('dashboard')" class="group flex flex-col justify-center items-center">-->
