...
<template>
    ...
    >
        ...
        <div class="max-w-7xl mx-auto items-start">
            ...
            <div class="my-10">
                <div class="sticky top-0 z-40 backdrop-blur border-b border-gray-200 mb-10">
                    <nav class="-mb-px flex" aria-label="Tabs">
                        ...
                        <button class=" w-1/2 py-4 px-1 text-center border-b-2 font-medium text-sm"
                                :class="tabCourseShow==2 ? 'border-cyan-600 text-cyan-600' : 'text-gray-500 border-gray-300 ' "
            ...
            <template v-else-if="tabCourseShow==2">
...
<!--                                                <i class="fa-solid fa-play mr-1"/>-->
                        ...
                        <div class="lg:col-span-4 py-3">
                            ...
                            <div v-if="tabLesson==99" class="bg-white bg-opacity-50 border border-gray-300 rounded-3xl shadow-lg p-5">
                                <div class=" ">
            ...
            <template v-else-if="tabCourseShow==3">
                <div class="relative mx-auto grid lg:grid-cols-6 gap-10">
                    ...
                    <div class="lg:col-span-4 py-3">
                        ...
                        <div v-if="tabAssigment==99" class="bg-white bg-opacity-50 border border-gray-300 rounded-3xl shadow-lg p-5">
                            <div class=" ">
                                <InputLabel for="name" value="Judul"/>
                                <TextInput
                                    id="name"
