        ...
        <div class="min-h-screen bg-gray-100 bg-glass bg-fixed">
            <nav class="px-3 mb-3 pt-3 w-full z-50 sticky top-0">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 lg:flex">
                                ...
                                <NavLink
                                    :href="route('landing.course')"
                                    :active="$page.url.startsWith('/kelas')"
                                >
                                    Kelas
                                </NavLink>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}"
                     class="lg:hidden mt-2 bg-white bg-opacity-50 backdrop-blur rounded-3xl border border-gray-300">
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('landing.welcome')" :active="route().current('landing.welcome')">
                            Beranda
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('landing.course')" :active="$page.url.startsWith('/kelas')">
                            Kelas
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('landing.project')" :active="$page.url.startsWith('/proyek')">
                            Proyek
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('landing.blog')" :active="$page.url.startsWith('/artikel')">
                            Artikel
                        </ResponsiveNavLink>
            ...
            <main class="">
                <div v-if="props.header" class=" relative ">
                    ...
                    <div
                        class="absolute w-full bottom-0 top-0 flex justify-center items-center bg-gradient-to-tr to-transparent from-gray-800 dark:from-gray-800">
